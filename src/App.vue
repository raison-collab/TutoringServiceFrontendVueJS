<template>
  <div class="content" style="display: flex; flex-direction: column; align-items: center; width: 100%; margin-left: 50%; margin-right: auto">
    <h1>Регистрация</h1>
    ...
    <form id="reg-form" method="post" style="display:flex;flex-direction: column;" class="reg-form form" @submit.prevent="registerUser">
      ...
      <button id="reg_button" type="submit" class="btn btn-secondary">Зрегистрироваться</button>
    </form>
  </div>
  ...
  methods: {
    registerUser() {
      if (this.validateForm()) {
        ...
        fetch("http://127.0.0.1:8887/api/auth/register", {
          method: "POST",
          headers: {
